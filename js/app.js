...
function initSmoothScrolling(container,animation){
 /*
	...
	*/
	...
	var sliderHeight = $('>div>a:first-of-type',container).outerHeight(false);
	...
	var slidesVisible = $(container).width() / $('>div>a:first-of-type',container).outerWidth(false);
...
// append the tail
	$('>div>a',container).slice(0,slidesVisible).clone().appendTo($('>div',container));
